...
try {
  await waitForServer();
  const tests = spawn(process.execPath, ["--experimental-strip-types", "--test", "tests/rendered-html.test.mjs", "tests/affiliate.test.mjs", "tests/affiliate-reporting.test.mjs", "tests/site-health.test.mjs", "tests/osaka-planning.test.mjs", "tests/pinterest-feed.test.mjs"], {
    cwd: new URL("../", import.meta.url),
